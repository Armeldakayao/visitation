...
export default function Page() {
    ...
    updateBookPurchase(
      ...
      },
      {
        onSuccess: () => {
          ...
          router.push(`/admin/visitation-books/view?token=${token}`);
        },
        onError: () => {
  ...
  return (
    <div className="mx-auto text-[#383838] p-7 bg-[#F8F5F5]">
      ...
      <div className="grid lg:grid-cols-7 grid-cols-1 lg:px-20 mt-7 py-10 lg:mx-16 px-10 border-t rounded-lg shadow-md bg-[#EBD6D6]">
        ...
        <div className="col-span-4 flex justify-center items-center mb-10 mt-10">
          {/* <div className=" ">
            ...
            <div className="relative left-50 right-50">
              <div className="flex justify-center ">
                ...
                <div // @ts-ignore
                  ...
                  className="relative z-10 w-full h-[300px]"
                >
                ...
                <img src="/images/bady.svg"  className=""/>
              </div>
            </div>
            <img className="image2 absolute" src="/images/both.svg" />
          </div>
