...
export default function Page() {
  ...
  return (
    <div className="mx-auto text-[#383838] p-7 bg-[#F8F5F5]">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 lg:px-20 mt-7 py-10 lg:mx-36 lg:border-t rounded-lg lg:shadow-md bg-[#F8F5F5]">
        <div></div>
        <div className="flex justify-end">
          <Button className="text-black">
        ...
        <div className="flex items-center justify-center">
          <div
            style={{
              backgroundImage: `url(http://34.27.136.91${validBook?.book?.cover})`,
        ...
        <div className="gap-5 mx-auto justify-between pt-5">
          ...
          <div className="bg-[#4A33330D] mx-auto lg:p-7 mt-7 flex justify-center items-center rounded-lg lg:shadow-lg ">
