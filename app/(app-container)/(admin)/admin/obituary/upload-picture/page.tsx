...
export default function Page() {
  ...
  return (
    <div className="mx-auto text-[#383838] bg-[#F8F5F5] p-7">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 px-20 mt-7 py-10 lg:mx-36 border-t rounded-lg lg:shadow-md bg-[#F8F5F5]">
        <div>
          <p className="font-bold text-[25px] mb-7 text-[#383838]">
            Upload the picture of the deceased
          </p>
            ...
            <div className="absolute top-[335px]">
              <div className="flex gap-7 mx-20">
                <div>
                  <img
                    // @ts-ignore
                    src={`http://34.27.136.91${validBook?.book?.cover}`}
                    width={150}
                    height={150}
                  />
                  <br />
