      ...
      <>
        <div className="grid grid-cols-2 lg:px-20 mt-7 py-10 lg:mx-36 lg:border-t rounded-lg xl:shadow-md bg-[#F8F5F5]">
          <div className=" col-span-2  flex   justify-between items-center">
            ...
            <div className=" flex  ">
              <Button
                onClick={() =>
                  router.push(
                    `/admin/visitation-books/scan-book?token=${token}`
                  )
                }
          ...
          <div className="md:flex hidden col-span-2 gap-5 pt-7 justify-between ">
            <Button className="border-[#f00] border   px-7 text-[#464647]">
            ...
            <div className="gap-5">
              ...
              <Button
                onClick={() =>
                  router.push(
                    `/admin/visitation-books/show-view?token=${token}`
                  )
                }
        ...
        <div className="grid grid-cols-2 lg:px-20 mt-7 py-10 lg:mx-36 lg:border-t rounded-lg xl:shadow-md bg-[#F8F5F5]">
                      ...
                      <div className=" flex justify-center items-center">
                        <div className="flex gap-7  ">
                          ...
                          <div className="px-7 md:px-20 py-2 rounded-lg lg:mr-28 pr-52  flex flex-col justify-center items-center ">
                            <div
                              style={{
                                backgroundImage: `url(http://34.44.9.82${validBookObituary?.book_cover})`,
                                backgroundRepeat: "no-repeat",
                                backgroundSize: "cover",
                                backgroundPosition: "center",
                              }}
                            ...
                            >
                              <p className="text-[20px] pb-5 font-bold text-[#575252]">
                                {validBookObituary?.deceased_name}
                              </p>
                              {/* <img
                            ...
                            /> */}
                              <p className="text-[12px] mt-2 font-bold text-[#575252]">
                                Born - {validBookObituary?.date_of_birth}
                              </p>
                              <p className="text-[12px] pb-5 font-bold text-[#575252]">
                                Passed - {validBookObituary?.date_of_death}
                              </p>
                            </div>
                          </div>
                        </div>
          ...
          <div className="md:flex hidden bg-white rounded-lg col-span-2 gap-5 p-10 justify-between ">
            <div>
              <p>Name</p>
              <p>{validBookObituary?.deceased_name}</p>
            </div>
            <div className="gap-5">
              <p>Actions</p>
              <div className="flex gap-4">
                ...
                <img
                  ...
                  onClick={() =>
                    router.push(
                      `/admin/obituary/create-obituary?token=${token}`
                    )
                  }
